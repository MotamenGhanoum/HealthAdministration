...
public class UltimateController{
    ...
    public String showRegistrationForm(Model model) {
        return "registrationul";
    }

    @PostMapping
    public String registerUserAccount( @Valid UserRegistrationDto userDto,
        ...
        userService.saveul(userDto);

        return "redirect:/registrationul?success";
    }
}
